...
class thanos::sidecar (
    ...
    Optional[String]  $grpc_advertise_address,
    ...
    Optional[String]  $cluster_advertise_address,
    Array   $cluster_peers                 = [],
    Optional[String]  $cluster_gossip_interval,
    Optional[String]  $cluster_pushpull_interval,
    Optional[String]  $cluster_refresh_interval,
    Optional[String]  $cluster_secret_key,
    String  $cluster_network_type          = 'wan',
    String  $prometheus_url                = 'http://localhost:9090',
    Optional[String]  $tsdb_path,
    ...
    Optional[String]  $reloader_config_file,
    Optional[String]  $reloader_config_envsubst_file,
    Optional[String]  $reloader_rule_dir,
